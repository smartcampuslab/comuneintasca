...
import eu.trentorise.smartcampus.comuneintasca.data.AppSyncSubStorage;
import eu.trentorise.smartcampus.comuneintasca.data.AppSyncSubStorageImpl;
...
//	private static final String CLASS_FIELD = "_class";
	...
	private AppSyncSubStorage getStorage() {
		if (storage == null) {
			storage = new AppSyncSubStorageImpl(mongoTemplate, COLLECTION); 
		}
		return storage;
	}
